...
class SiteLog(wx.Frame):
    def __init__(self):
        wx.Frame.__init__(self, None, title='Excel制作工具0713>>>徐浩峰:13554941602', size=(450, 480))
        self.Center()
        ...
        message_one = u'下载最新软件及排班模板:www.baidu.com'

        self.author = wx.TextCtrl(self, value=message_one, pos=(3, 110), size=(350, 25),
        ...
        self.author.Bind(wx.EVT_TEXT_URL, self.OnButton)
